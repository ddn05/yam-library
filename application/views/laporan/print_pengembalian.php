        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo date("d-m-Y", strtotime( $pen->tgl_pinjam))?></td>
                    <td><?php echo date("d-m-Y", strtotime($pen->tgl_dikembalikan))?></td>
                    <td>Rp.<?php
                        if($pen->total_denda == NULL){
                            echo 0;
                        }
                        else{
                            echo $pen->total_denda ;
                        }?>;</td>
                </tr>
            <?php } ?>
        </tbody>
